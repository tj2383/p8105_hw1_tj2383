...
I computed means for the random sample, the logical vector, the character vector, and the factor vector. I then attempted to convert the logical, character, and factor vectors to numeric vectors.

```{r mean_code eval = FALSE} 
