...
## Since each character variable is unique it created 10 levels when converting to the factor (categorical) variables.

as.numeric(new_factorvec)
## Assigned random numbers to the 10 level factor (categorical) variable.
